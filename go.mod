...
replace (
	github.com/uhppoted/uhppote-core v0.0.0-20200228192138-00c62a4d6ea3 => ./uhppote-core
	github.com/uhppoted/uhppoted-api v0.0.0-20200228200222-5bade7b61e14 => ./uhppoted-api
)
