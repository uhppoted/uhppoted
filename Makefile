...
build-all: test vet
	...
	cd uhppote-cli && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)    ./...
	cd uhppote-cli && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)     ./...
	cd uhppote-cli && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)   ./...
	cd uhppote-cli && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST)  ./...

	cd uhppoted-rest && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppoted-rest && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppoted-rest && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppoted-rest && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...

	cd uhppoted-mqtt && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppoted-mqtt && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppoted-mqtt && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppoted-mqtt && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...	

	cd uhppoted-app-s3 && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppoted-app-s3 && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppoted-app-s3 && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppoted-app-s3 && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...	

	cd uhppoted-app-sheets && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppoted-app-sheets && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppoted-app-sheets && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppoted-app-sheets && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...	

	cd uhppoted-app-wild-apricot && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppoted-app-wild-apricot && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppoted-app-wild-apricot && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppoted-app-wild-apricot && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...	

	cd uhppote-simulator && env GOOS=linux   GOARCH=amd64       go build -trimpath -o ../dist/linux/$(DIST)   ./...
	cd uhppote-simulator && env GOOS=linux   GOARCH=arm GOARM=7 go build -trimpath -o ../dist/arm7/$(DIST)    ./...
	cd uhppote-simulator && env GOOS=darwin  GOARCH=amd64       go build -trimpath -o ../dist/darwin/$(DIST)  ./...
	cd uhppote-simulator && env GOOS=windows GOARCH=amd64       go build -trimpath -o ../dist/windows/$(DIST) ./...
