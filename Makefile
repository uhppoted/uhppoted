...
fly.io:
	cd uhppote-simulator && env GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -o ../docker/fly.io ./...
	cd uhppoted-httpd    && env GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -o ../docker/fly.io ./...
