...
func TestMarshalGetDoorDelayRequest(t *testing.T) {
	expected := []byte{
...
func TestUnmarshalGetDoorDelayResponse(t *testing.T) {
	message := []byte{
		0x17, 0x82, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x04, 0x03, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
...
func TestUnmarshalGetDoorDelayResponseWithInvalidMsgType(t *testing.T) {
	message := []byte{
