...
func TestUnmarshalArrayOfStruct(t *testing.T) {
	message := []byte{
		,
	}
	...
	if len(reply) != 2 {
		t.Errorf("Expected array of length %d, got: %d\n", 2, len(reply))
	}

	if reply[0].MsgType != 0x94 {
		t.Errorf("Expected 'byte':0x%02X, got: 0x%02X\n", 0x94, reply[0].MsgType)
	}
